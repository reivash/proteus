"""Add trend tracking methods to fast_bear_detector.py"""
...
def main():
    ...
    if insertion_marker in content:
        content = content.replace(insertion_marker, TREND_METHODS + insertion_marker)
        print("Added trend tracking methods")
    else:

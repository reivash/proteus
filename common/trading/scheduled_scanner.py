...
Usage:
    python common/trading/scheduled_scanner.py --run-once  # Single run
    python common/trading/scheduled_scanner.py --schedule  # Run on schedule
"""
...
from common.trading.smart_scanner import SmartScanner, SmartSignal
...
class ScheduledScanner:
    ...
    def update_dashboard(self):
        ...
        try:
            from common.web.dashboard_generator import update_dashboard
            update_dashboard()

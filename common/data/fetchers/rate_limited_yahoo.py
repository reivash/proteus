...
if __name__ == "__main__":
    ...
    print()
    print("DEPLOYMENT:")
    print("Replace 'from common.data.fetchers.yahoo_finance import YahooFinanceFetcher'")
    print("With 'from common.data.fetchers.rate_limited_yahoo import RateLimitedYahooFinanceFetcher'")
    print()
    print("Benefits:")

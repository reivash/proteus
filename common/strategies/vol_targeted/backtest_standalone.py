"""
Backtester for Vol-Targeted Strategy (Standalone version)
...
from strategy_standalone import VolTargetedStrategy
...
class Backtester:
    ...
    def _compute_statistics(
        ...
        avg_vol_estimate = np.mean(vol_estimates[vol_estimates > 0]) if np.any(vol_estimates > 0) else 0.0

...
- Save portfolio snapshot to `features/simulation/data/portfolio_snapshot_[timestamp].json`
...
1. **Load your previous snapshot:**
   ...
   with open('features/simulation/data/portfolio_snapshot_20251201_163641.json', 'r') as f:
